...
Data can be read in as either a data frame or a comma separated file (csv). The preferred approach is to read an existing data frame in \proglang{R} because the type of variables (factor, numeric, ...) are preserved. \code{MissingDataGUI(data)} is the starting function in this case.
